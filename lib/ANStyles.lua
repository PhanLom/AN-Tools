...
function style(id)
    ...
    elseif id == 7 then -- blue contrast
        colors[clr.Text]                   = ImVec4(1.00, 1.00, 1.00, 1.00) -- білий текст
        colors[clr.TextDisabled]           = ImVec4(0.70, 0.70, 0.70, 1.00)
        colors[clr.WindowBg]               = ImVec4(0.20, 0.36, 0.50, 1.00) -- #345b7f
        colors[clr.ChildWindowBg]          = ImVec4(0.22, 0.40, 0.56, 1.00)
        colors[clr.PopupBg]                = ImVec4(0.18, 0.32, 0.45, 0.98)
        colors[clr.Border]                 = ImVec4(1.00, 1.00, 1.00, 0.40)
        colors[clr.BorderShadow]           = ImVec4(0.00, 0.00, 0.00, 0.00)
        colors[clr.FrameBg]                = ImVec4(0.12, 0.22, 0.32, 1.00)
        colors[clr.FrameBgHovered]         = ImVec4(0.30, 0.50, 0.70, 0.60)
        colors[clr.FrameBgActive]          = ImVec4(0.40, 0.60, 0.90, 0.80)
        colors[clr.TitleBg]                = ImVec4(0.16, 0.28, 0.40, 1.00)
        colors[clr.TitleBgActive]          = ImVec4(0.20, 0.36, 0.50, 1.00)
        colors[clr.TitleBgCollapsed]       = ImVec4(0.16, 0.28, 0.40, 0.75)
        colors[clr.MenuBarBg]              = ImVec4(0.18, 0.32, 0.45, 1.00)
        colors[clr.ScrollbarBg]            = ImVec4(0.20, 0.36, 0.50, 0.00)
        colors[clr.ScrollbarGrab]          = ImVec4(1.00, 1.00, 1.00, 0.60)
        colors[clr.ScrollbarGrabHovered]   = ImVec4(1.00, 1.00, 1.00, 0.80)
        colors[clr.ScrollbarGrabActive]    = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.ComboBg]                = ImVec4(0.22, 0.40, 0.56, 1.00)
        colors[clr.CheckMark]              = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.SliderGrab]             = ImVec4(1.00, 1.00, 1.00, 0.80)
        colors[clr.SliderGrabActive]       = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.Button]                 = ImVec4(1.00, 1.00, 1.00, 0.15)
        colors[clr.ButtonHovered]          = ImVec4(1.00, 1.00, 1.00, 0.30)
        colors[clr.ButtonActive]           = ImVec4(1.00, 1.00, 1.00, 0.50)
        colors[clr.Header]                 = ImVec4(1.00, 1.00, 1.00, 0.15)
        colors[clr.HeaderHovered]          = ImVec4(1.00, 1.00, 1.00, 0.30)
        colors[clr.HeaderActive]           = ImVec4(1.00, 1.00, 1.00, 0.50)
        colors[clr.Separator]              = ImVec4(1.00, 1.00, 1.00, 0.40)
        colors[clr.SeparatorHovered]       = ImVec4(1.00, 1.00, 1.00, 0.60)
        colors[clr.SeparatorActive]        = ImVec4(1.00, 1.00, 1.00, 0.80)
        colors[clr.ResizeGrip]             = ImVec4(1.00, 1.00, 1.00, 0.40)
        colors[clr.ResizeGripHovered]      = ImVec4(1.00, 1.00, 1.00, 0.60)
        colors[clr.ResizeGripActive]       = ImVec4(1.00, 1.00, 1.00, 0.80)
        colors[clr.CloseButton]            = ImVec4(1.00, 1.00, 1.00, 0.40)
        colors[clr.CloseButtonHovered]     = ImVec4(1.00, 1.00, 1.00, 0.60)
        colors[clr.CloseButtonActive]      = ImVec4(1.00, 1.00, 1.00, 0.80)
        colors[clr.PlotLines]              = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.PlotLinesHovered]       = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.PlotHistogram]          = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.PlotHistogramHovered]   = ImVec4(1.00, 1.00, 1.00, 1.00)
        colors[clr.TextSelectedBg]         = ImVec4(1.00, 1.00, 1.00, 0.30)
        colors[clr.ModalWindowDarkening]   = ImVec4(0.20, 0.36, 0.50, 0.80)
    end
end